 ...
 * Returns an owned PID [0; 31] or negative for error case.
 */
 ...
 * 5) Return again to the first step if the operation failed.
 *
 ...
 * SFPB Implementation:
 *
 * The design of this is dealy simple: we just read and store the values to
 * a specified memory address. This is the simpliest and clearest possible
 * implementation of locking. Used by all modern targets instead of *EX due
 * to its simplicity.
 */
